...
<html>
	...
	<body>
		...
		<form method="post" id="frm">
		    ...
		    <div>비밀번호: <input type="password" name="passwd" id="passwd"></div>
			<div class="g-recaptcha" data-sitekey="6LfYIwgbAAAAAJH66wTOE11GOtExqC-Svf_sATdq" data-callback="onSubmit"></div>
...
// 묻는 방법으로부터 시작해서 지금은 다양한 기법으로 사용되고 있음

// 웹 사이트에 접근하는 대상이 사람인지 봇인지 판단하기 위해
// 사용하는 테스트의 일종
